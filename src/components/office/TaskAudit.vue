    ...
    <div style="margin-top: 10px;justify-content: center">
      ...
      <el-dialog
        ...
        <div style="margin-left: 5px">
          ...
          <div v-if="detailsTask.state==='AUDIT'">
            <el-row style="margin-top: 10px">
              <el-col>
                审核意见：
              </el-col>
              <el-col>
                <el-input
                    type="textarea"
                    placeholder="请输入内容"
                    v-model="detailsTask.auditResult"
        ...
        <span slot="footer" class="dialog-footer" style="margin-top: 2px" v-if="detailsTask.state==='AUDIT'">
...
export default {
  ...
  methods: {
    initTasks() {
      this.getRequest('/task/auditorTask?currentPage='
