...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        changeCurrentSession(state, currentSession) {
            ...
            Vue.set(state.idDot,
                state.currentAdmin.username + '#' + state.currentSession.username, false);
        },
    ...
    actions: {
        initData(context) {
            ...
            getRequest('/chat/user/').then(resp => {
                if (resp) {
        ...
        connect(context) {
            context.state.stomp = Stomp.over(new SockJS('/websocket/ep'));
            ...
            context.state.stomp.connect({'Auth-Token': token}, success => {
                context.state.stomp.subscribe('/user/queue/chat', msg => {
                    ...
                    if (!context.state.currentSession
                        ...
                        Vue.set(context.state.idDot,
                            context.state.currentAdmin.username + '#' + receiveMsg.from, true);
                    }
